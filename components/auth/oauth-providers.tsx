...
// For now using simple icon representations - you can replace with actual logo components
const GoogleIcon = () => (
...
const providers: OAuthProvider[] = [
    ...
    { id: "github", name: "GitHub", icon: GitHubIcon, enabled: false }, // Enable when configured
    { id: "microsoft", name: "Microsoft", icon: MicrosoftIcon, enabled: false }, // Enable when configured
]
                ...
                return (
                    <div key={provider.id} className="relative group">
                        <Button
                            ...
                            variant="ghost"
                            size="lg"
                            className="w-16 h-16 p-2 rounded-full hover:bg-transparent hover:shadow-lg hover:scale-105 transition-all duration-200 border-0"
